...
public:
	...
	static constexpr Inputs::ControllerKey KeysOrder[Inputs::NUMBER_KEYS] { Inputs::CK_UP, Inputs::CK_LEFT,
		Inputs::CK_DOWN, Inputs::CK_RIGHT, Inputs::CK_FIREA, Inputs::CK_FIREB };
