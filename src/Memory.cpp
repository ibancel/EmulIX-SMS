...
Memory::Memory(System& parent) : SystemComponent(parent) { init(); }
...
u8 Memory::read(u16 address)
{
	if(address < 0x400) {
		...
		if(address == Paging_Reg::kRamSelect || address == Paging_Reg::kBank0 || address == Paging_Reg::kBank1
			|| address == Paging_Reg::kBank2) {
			return _memory[address - 0x2000];
		} else {
...
MemoryBank Memory::getBank0() { return _memoryBank0; }

MemoryBank Memory::getBank1() { return _memoryBank1; }

MemoryBank Memory::getBank2() { return _memoryBank2; }
