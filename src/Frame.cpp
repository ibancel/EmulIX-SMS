...
Frame::Frame(int width, int height, const PixelColor& color) : Frame(width, height)
{
...
void Frame::setBackdropColor(const PixelColor& iColor) { _backdropColor = iColor; }

void Frame::setPixel(int x, int y, const PixelColor& iColor) { setPixel(posToPosIndex(x, y), iColor); }
